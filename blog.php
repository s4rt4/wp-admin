...
<head>
    ...
    <title><?php echo htmlspecialchars(get_option('blogname', get_option('site_title', 'My Blog'))); ?> - <?php echo htmlspecialchars(get_option('blogdescription', get_option('site_description', 'Just another WordPress site'))); ?></title>
    <style>
...
$site_title = get_option('blogname', get_option('site_title', 'My Blog'));
if ($site_logo): ?>
