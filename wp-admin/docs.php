...
function topic_label(string $topic): string
{
    $map = [
        ...
        'tools-form-builder' => 'Form Builder',
        'tools-kanban' => 'Kanban Board',
        ...
        'settings-security' => 'Security Headers',
        'settings-integrity' => 'File Integrity',
    ...
    $groups = [
        ...
        [
            ...
            'items' => [
                ...
                ['topic'=>'tools-plugins','en'=>'Plugins','id'=>'Plugins'],
                ['topic'=>'tools-messages','en'=>'Messages','id'=>'Pesan Internal'],
                ['topic'=>'settings-security','en'=>'Security Headers','id'=>'Security Headers'],
                ['topic'=>'settings-integrity','en'=>'File Integrity','id'=>'File Integrity'],
                ['topic'=>'settings-login-security','en'=>'Login Security','id'=>'Login Security'],
                ['topic'=>'settings-updates','en'=>'Updates','id'=>'Updates'],
